...
<div class="navbar-header"><button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1"><span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button>[  <span class="projectTitle">Cloud Integration</span>](https://ibm-cloudintegration.github.io/techguides/index.html)</div>

<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">

*   [Nav](#)
*   [Tech Guides](#)
    *   [App Connect (Studio) Demo for Salesforce](https://ibm-cloudintegration.github.io/techguides/sfdemo_start.html)
    *   [App Connect (Designer) Labs for Dreamforce 2017](https://ibm-cloudintegration.github.io/techguides/df17labs_start.html)
    *   [App Connect (Designer) Labs for FastStart 2018](https://ibm-cloudintegration.github.io/techguides/fs18labs_start.html)
*   [Feedback](# "Submit feedback")
*   <div id="search-demo-container"><input id="search-input" placeholder="search..." type="text"></div>

    <script type="text/javascript">SimpleJekyllSearch.init({ searchInput: document.getElementById('search-input'), resultsContainer: document.getElementById('results-container'), dataSource: 'search.json', searchResultTemplate: '<li><a href="{url}" title="CIP Bootcamp">{title}</a></li>', noResultsText: 'No results found.', limit: 10, fuzzy: true, })</script>
...
<script>$("li.active").parents('li').toggleClass("active");</script></div>
...
<div class="summary">Introduction to the Cloud Integration Platform</div>
